...
CREATE TABLE pre_forum_forum (
  ...
  disableoldthreadview int(10) NOT NULL DEFAULT '0',
  dotvwithoutdisplayorder tinyint(1) NOT NULL DEFAULT '0',
  dotvwithoutdigest tinyint(1) NOT NULL DEFAULT '0',
  dotvwithoutuids text DEFAULT '',
  PRIMARY KEY (fid),
