...
<div class="tip loginbox loginpop p5">
    <h2 class="log_tit">{lang post_tag}</h2>
    <dt>
        <p>
    ...
    <p style="padding-bottom: 10px"><span class="xg1">{lang posttag_comment}</span></p>
    <dd>
        <input type="button" name="search_button" id="search_button" value="{lang submit}" onclick="tagset();" class="formdialog button z">
        <a href="javascript:;" onclick="popup.close();" class="button y">{lang close}</a>
    </dd>
</div>
<!--{else}-->
<h3 class="flb">
