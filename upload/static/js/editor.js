		...
		switch(tag) {
			...
			case 'fls':
				if($(ctrlid + '_param_2').value && $(ctrlid + '_param_3').value) {
					insertText('[flash=' + ($(ctrlid + '_param_2').value.match(/^(auto|\d+%?)$/i) ? $(ctrlid + '_param_2').value : 500) + ',' + ($(ctrlid + '_param_3').value.match(/^(auto|\d+%?)$/i) + ']' + squarestrip($(ctrlid + '_param_1').value) + '[/flash]', 7, 8, false, sel);
				} else {
			...
			case 'vid':
				...
				var str = '[media=' + ext + ',' + ($(ctrlid + '_param_2').value.match(/^(auto|\d+%?)$/i) ? $(ctrlid + '_param_2').value : 500) + ',' + ($(ctrlid + '_param_3').value.match(/^(auto|\d+%?)$/i) + ']' + squarestrip(mediaUrl) + '[/media]';
				insertText(str, str.length, 0, false, sel);
				break;
			case 'image':
