...
function profile_show($fieldid, $space=array(), $getalone = false) {
	...
	if($fieldid=='gender') {
		...
		return '<a href="tencent://Message/?uin='.$space[$fieldid].'&site='.$_G['setting']['bbname'].'&menu=yes&from=discuz" target="_blank" title="'.lang('spacecp', 'qq_dialog').'"><img src="'.STATICURL.'/image/common/qq.gif" alt="QQ" style="margin:0px;"/></a>';
