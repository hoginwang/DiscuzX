...
$lang = array (
  ...
  'members_edit_illegal' => '您不能直接禁止该用户，请<a href="{ADMINSCRIPT}?action=members&operation=search&uid={uid}&frames=yes" target="_blank">编辑</a>去掉其“{grouptitle}”身份',
  'members_edit_illegal_portal' => '您不能直接禁止该用户，请<a href="{ADMINSCRIPT}?action=portalpermission&uid={uid}&frames=yes" target="_blank">查询其门户相关权限</a>并清除',
