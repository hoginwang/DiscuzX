...
$lang = array (
  ...
  'pay_wechat_update_succeed' => '平台证书更新成功 ',
  'pay_wechat_update_fail' => '平台证书更新失败 ',
  'pay_wechat_privateKey_fail' => '商户私钥文件不存在 ',
  'pay_wechat_privateKey_succeed' => '商户私钥导入成功 ',
  'pay_orders_disabled' => '您没有启用交易积分或支付宝、微信支付积分充值功能，无法对订单进行管理',
  'pay_wechat_php' => '请使用 PHP>=7.1 才能启用微信支付',
