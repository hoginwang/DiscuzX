...
$lang = array (
  ...
  'group_changetype_confirm' => '确认要将所选群组移动到分类 <span class="highlight">[{targetname}]</span> 下吗？',
  'group_mergegroup_confirm' => '合并群组操作不可恢复，确认要合并到群组 <span class="highlight">[{targetname}]</span> 吗？',
