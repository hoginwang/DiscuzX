...
',
	...
	array (
		...
		array (
			...
			5 => '本地附件 URL 地址',
			6 => '可为当前 URL 下的相对地址或 http:// 或 https:// 开头的绝对地址，结尾不加 "/"，不能把这个设为远程附件URL地址',
			7 => 'setting_attach_image_lib',
			8 => '图片处理库类型',
			9 => '请选择 Discuz! 用来处理缩略图和水印的图像处理库。GD 是最广泛的处理库但是使用的系统资源较多。ImageMagick 速度快系统资源占用少，但安全性相对较差，且需要服务器安装 ImageMagick 扩展。如果您的服务器有条件安装此程序，请到 https://www.imagemagick.org 下载',
