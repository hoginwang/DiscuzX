...
',
  ...
  array (
    ...
    array (
      ...
      11 => '允许查看会员列表',
      12 => 'setting_permissions_guestviewprofile',
      13 => '允许游客浏览用户资料及空间页',
      14 => 'setting_permissions_minpostsize',
      15 => '帖子最小字数(字节)',
      16 => '管理组成员可通过“发帖不受限制”设置而不受影响，0 为不限制',
      17 => 'setting_permissions_minpostsize_mobile',
      18 => '手机客户端发帖最小字数(字节)',
      19 => '是否单独为手机客户端设置发帖的最小字节数，0 为不单独设置',
      20 => 'setting_permissions_maxpostsize',
      21 => '帖子最大字数(字节)',
      22 => '管理组成员可通过“发帖不受限制”设置而不受影响',
      23 => 'setting_permissions_alloweditpost',
      24 => '允许用户随时编辑的帖子类型',
      25 => '被选中的帖子类型将不受用户组中的“编辑帖子时间”限制，任何时刻都可以编辑',
      26 => 'setting_permissions_post_append',
      27 => '启用帖子补充功能',
      28 => '启用后，当用户无法编辑自己的帖子时，可以补充内容',
      29 => 'setting_permissions_maxpolloptions',
      30 => '投票最大选项数:',
      31 => '设定发布投票包含的最大选项数',
      32 => 'setting_permissions_editby',
      33 => '编辑帖子附加编辑记录',
      34 => '在 60 秒后编辑帖子添加“本帖由 xxx 于 xxxx-xx-xx 编辑”字样。管理员编辑不受此限制',
      35 => 'nav_setting_rate',
      36 => '评分',
      37 => 'setting_permissions_karmaratelimit',
      38 => '评分时间限制(小时)',
      39 => '帖子发表后超过此时间限制其他用户将不能对此帖评分，版主和管理员不受此限制，0 为不限制',
      40 => 'setting_permissions_modratelimit',
      41 => '版主评分限制',
      42 => '设置版主只能在自身所管辖的版块范围内对帖子进行评分。本限制只对版主有效，允许评分的普通用户及超级版主、管理员不受此限制，因此如果赋予这些用户评分权限，他们仍将可以在全版块范围内进行评分',
      43 => 'setting_permissions_dupkarmarate',
      44 => '允许重复评分',
      45 => '选择“是”将允许用户对一个帖子进行多次评分，默认为“否”',
      46 => 'setting_permissions_editperdel',
      47 => '允许用户编辑帖子时删除帖子',
      48 => '选择“是”将允许用户编辑帖子时删除帖子，默认为“否”',
      49 => 'setting_permissions_hideexpiration',
      50 => '帖子中[hide]标签最大有效天数',
      51 => '距发帖日期天数超过此设置时标签自动失效，0或不填为不限制',
    ),
  ),
  254 => 
  array (
