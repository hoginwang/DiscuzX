...
$lang = array (
  ...
  'topicadmin_warn_prompt' => '{$_G[setting][warningrange]} 天内累计被警告 {$_G[setting][warninglimit]} 次，将被自动禁止发帖 {$_G[setting][warningexpiration]} 天',
  ...
  'warn_view_prompt' => '$warnuser 已被累计警告 $warnnum 次，{$_G[setting][warningrange]} 天内累计被警告 {$_G[setting][warninglimit]} 次，将被自动禁止发帖 {$_G[setting][warningexpiration]} 天',
  'main_nav' => '主导航',
  'quick_nav' => '快捷导航',
