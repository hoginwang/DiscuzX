...
$lang = array (
  ...
  'index_invisibles' => '隐身',
  'index_members' => '位建筑同行',
  'index_members_end' => '位建筑同行',
  'index_mostonlines' => '最高记录是',
  'index_posts' => '，在<font color=red>建筑吧</font>交流',
  'index_today' => '今日',
  'index_yesterday' => '昨日',
  'my_posts' => '我的帖子',
  'never' => '从未',
  ...
  'post_hide_reply_hidden' => '，<B><font color="Red">还有更精彩的内容，请您<a href="forum.php?mod=post&action=reply&fid=$_G[fid]&tid=$_G[tid]" onclick="showWindow(\'reply\', this.href)">回复</a>后查看，回复当日有效！</font></B>',
  'set_cover' => '设为封面',
  'upload' => '上传',
  ...
  'no_closed_to_post' => '本帖已关闭，您无法再回复。',
  ...
  'admin_message_single_banned' => '提示: <em>该帖是欺诈信息或恶意灌水被屏蔽，只有管理员或有管理权限的成员可见</em>',
  ...
  'message_single_banned' => '提示: <em>该帖是欺诈信息或恶意灌水被屏蔽，请珍惜自己的帐号！</em>',
