...
$lang = array (
  ...
  'forum_permforum_nopermission' => '您需要满足以下条件才能访问这个版块<p><b>访问条件： </b><br />{formulamessage}<br /><b>您的信息： </b>{usermsg}',
  'forum_permforum_nopermission_custommsg' => '<p>{formulamessage}',
  'viewperm_none_nopermission' => '抱歉，您没有权限访问该版块',
  'viewperm_upgrade_nopermission' => '抱歉，您需要升级您所在的用户组后才能访问该版块，详细请 <a href="home.php?mod=spacecp&ac=usergroup&do=forum" target="_blank">点击这里查看</a>。<p><b>有权访问的用户组或认证用户为：</b><br />{permgroups}',
  'viewperm_login_nopermission' => '抱歉，您尚未登录，没有权限访问该版块',
  'postperm_upgrade_nopermission' => '抱歉，您需要升级所在的用户组后才能发帖，详细请 <a href="home.php?mod=spacecp&ac=usergroup&do=forum" target="_blank">点击这里查看</a>。<p><b>有权发帖的用户组或认证用户为：</b><br />{permgroups}',
  'replyperm_upgrade_nopermission' => '抱歉，您需要升级所在的用户组后才能回帖，详细请 <a href="home.php?mod=spacecp&ac=usergroup&do=forum" target="_blank">点击这里查看</a>。<p><b>有权回帖的用户组或认证用户为：</b><br />{permgroups}',
  'getattachperm_upgrade_nopermission' => '抱歉，您需要升级所在的用户组才能下载本附件，详细请 <a href="home.php?mod=spacecp&ac=usergroup&do=forum" target="_blank">点击这里查看</a>。<p><b>有权下载附件的用户组或认证用户为：</b><br />{permgroups}',
  'getattachperm_login_nopermission' => '抱歉，您尚未登录，没有权限下载本附件',
  'postattachperm_none_nopermission' => '抱歉，您没有权限上传附件 ',
  'postattachperm_upgrade_nopermission' => '抱歉，您需要升级您所在的用户组后才能上传附件，详细请 <a href="home.php?mod=spacecp&ac=usergroup&do=forum" target="_blank">点击这里查看</a>。<p><b>有权上传附件的用户组或认证用户为：</b><br />{permgroups}',
