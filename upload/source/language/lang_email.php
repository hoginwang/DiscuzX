...
----------------------------------------------------------------------</p>
<p>我们收到了您重置密码的申请。</p>
<p>如果您未提出此请求，请忽略此邮件；否则，请点击以下链接重设您的密码：</p>
...
----------------------------------------------------------------------</p>
<br />
<p>如果您是 {bbname} 的新用户，我们需要对您的地址有效性进行验证。</p>

<p>您只需点击下面的链接即可进行用户注册，以下链接有效期为3天。<br />
...
刚刚被添加成为 {bbname} 的会员，当前 Email 即是我们为您注册的邮箱地址。</p>
<p>
----------------------------------------------------------------------<br />
重要！<br />
----------------------------------------------------------------------</p>
