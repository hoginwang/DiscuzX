...
<br />(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
	...
	'setting_pay' => '支付中心基本设置',
	'setting_pay_credittrade' => '积分兑换设置',
	'setting_pay_goodstrade' => '商品相关设置',
	'setting_pay_ratio' => '现金/积分兑换比率',
	'setting_pay_ratio_comment' => '设置真实货币现金(以人民币元为单位)与站点交易积分间的兑换比率，例如设置为 10，则 1 元人民币可以兑换 10 个单位的交易积分。本功能需开启交易积分，并成功进行财付通、支付宝收款账号的相关设置后方可使用，如果禁止使用现金与交易积分的兑换功能，请设置为 0',
	'setting_pay_mincredits' => '单次购买最小积分数额',
	'setting_pay_mincredits_comment' => '设置用户一次支付所购买的交易积分的最小数额，单位为交易积分的单位，0 为不限制',
	'setting_pay_maxcredits' => '单次购买最大积分数额',
	'setting_pay_maxcredits_comment' => '设置用户一次支付所购买的交易积分的最大数额，单位为交易积分的单位，0 为不限制',
	'setting_pay_maxcreditspermonth' => '每月购买最大积分数额',
	'setting_pay_maxcreditspermonth_comment' => '设置用户每月能够通过在线支付方式购买的交易积分的最大数额，单位为交易积分的单位，0 为不限制',
...
<li><b>由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用财付通积分交易功能(不包含财付通按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。</b></li><li>您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买帖子内容、购买用户组权限、积分转账或用户组升级等功能。财付通积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款财付通账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。</li><li>除 Discuz! 官方网站或官方论坛另行通知以外，Discuz! 提供的财付通支付服务每笔交易收取 1% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Discuz! 官方网站或官方论坛提供的信息为准。</li><li>您使用财付通服务是建立在完全自愿的基础上，除 Discuz! 因主观恶意的因素造成的资金损失以外，腾讯云不对因使用此功能造成的任何损失承担责任。</li><li>财付通服务热线：0755-83762288-2(全天24小时服务热线)</li>',
	...
	'pay_type' => '支付类型',
	'pay_alipay_status' => '开启支付宝',
	'pay_alipay' => '支付宝',
	'pay_alipay_set' => '支付宝设置',
	'pay_alipay_tips' => '<li>支付宝(<a href="https://open.alipay.com/" target="_blank">https://open.alipay.com</a>) 接口加签方式采用是<b>RSA2</b>，安全建议网站采用<b>HTTPS协议</b>，支持PC端，手机浏览器。</li> ',
	'pay_alipay_appid' => '应用appid',
	'pay_alipay_appid_comment' => '必须配置! 控制台-我的应用-自研服务-网页&移动应用，设置地址：https://open.alipay.com/platform/developerIndex.htm',
	'pay_alipay_seller_id' => '支付宝账号ID',
	'pay_alipay_seller_id_comment' => '必须配置! 账号中心-主账号管理-账号ID，获取地址：https://open.alipay.com/dev/workspace/account-center/main-account-manage',
	'pay_alipay_publickey' => '支付宝公钥 (RSA2)',
	'pay_alipay_publickey_comment' => '必须配置! 控制台-我的应用-自研服务-网页&移动应用 - "你的应用" - 应用信息 - 接口加签方式。https://miniu.alipay.com/keytool/create 例如：MIIBIjANBg...',
	'pay_alipay_merchantprivatekey' => '应用私钥 (RSA2)',
	'pay_alipay_merchantprivatekey_comment' => '必须配置! 控制台-我的应用-自研服务-网页&移动应用 - "你的应用" - 应用信息 - 接口加签方式。https://miniu.alipay.com/keytool/create 例如：MIIEvQIBADANB...',
	
	'pay_wechat_tips' => '<li>微信支付(<a href="https://pay.weixin.qq.com/" target="_blank">https://pay.weixin.qq.com</a>)，微信支付接口采用是<b>APIV3</b> (PHP 7.1以上)，安全建议网站采用<b>HTTPS协议</b>，支持PC端(Native)，手机浏览器(H5)，微信浏览器(JSAPI)，微信小程序支付。</li><li>接入前准备 : https://pay.weixin.qq.com/wiki/doc/apiv3/open/pay/chapter2_1.shtml#part-4</li>',
	'pay_wechat_status' => '开启微信支付',
	'pay_wechat' => '微信支付',
	'pay_wechat_set' => '微信支付设置',
	'pay_wechat_appid' => '公众账号ID',
	'pay_wechat_appid_comment' => '必须配置! 公众账号ID',
	'pay_wechat_appsecret' => '公众帐号secert',
	'pay_wechat_appsecret_comment' => '微信浏览器中，支付需要配置，(仅JSAPI支付)',
	'pay_wechat_mchid' => '商户号',
	'pay_wechat_mchid_comment' => '必须配置! 账户信息-基本账户信息-微信支付商户号 获取地址：https://pay.weixin.qq.com/index.php/core/account/info',
	'pay_wechat_key' => 'APIv3密钥',
	'pay_wechat_key_comment' => '必须配置! 设置地址：https://pay.weixin.qq.com/core/cert/api_cert',
	'pay_wechat_certNo' =>'证书序列号',
	'pay_wechat_certNo_comment' =>'必须配置! API证书 - 证书序列号 设置地址：https://pay.weixin.qq.com/core/cert/api_cert',
	'pay_wechat_privateKey' =>'商户私钥',
	'pay_wechat_privateKey_comment' =>'必须配置! https://kf.qq.com/faq/161222NneAJf161222U7fARv.html 请保存在本地证书文件 apiclient_key.pem 将apiclient_key.pem 上传到data文件夹下，然后请点击<a href="'.ADMINSCRIPT.'?action=pay&operation=wechat&cert=privateKey">导入商户私钥</a>。 ',
	'pay_wechat_cert' =>'平台证书存储地址',
	'pay_wechat_cert_comment' =>'必须配置!  默认：data/cert ，可以自定义。所有参数都设置保存后，请点击<a href="'.ADMINSCRIPT.'?action=pay&operation=wechat&cert=update">更新平台证书</a>，将在你设置存储地址生成平台证书文件（后缀为.pem），必须拥有此文件才能进行微信支付！(注：重新设置存储地址，必须更新平台证书！)',
	'pay_wechat_min_appid' => '微信小程序appid',
	'pay_wechat_min_appid_comment' => '微信小程序支付 （仅微信小程序支付）',
	'pay_wechat_min_appsecret' => '微信小程序secert',
	'pay_wechat_min_appsecret_comment' => '微信小程序支付需要配置，（仅微信小程序支付）',
	'pay_wechat_app_appid' => '移动应用appid',
	'pay_wechat_app_appid_comment' => '微信开放平台 - 移动应用appid （仅移动应用支付）',

	'pay_orders' => '积分充值订单',
	'pay_orders_tips' => '<li>如果您的用户反映在线支付后无法自动为其积分账户充值，可能是由于您的微信和支付宝账户的通知接口设置有误，或您的网站无法被微信和支付宝通知系统正常访问所致。您可以登录微信和支付宝交易管理界面，通过比对交易详情人工确认相关订单。</li><li>订单信息保留 60 天，因此您只能查询和管理 60 天之内的订单信息，超过 60 天的信息将被自动删除。</li>',
	'pay_orders_search' => '积分充值订单搜索',
	'pay_inviteorders_status' => '订单状态',
	'pay_orders_search_status' => '订单状态',
	'pay_orders_search_status_all' => '全部状态',
	'pay_orders_search_status_pending' => '等待付款',
	'pay_orders_search_status_auto_finished' => '成功在线支付',
	'pay_orders_search_status_manual_finished' => '成功人工补单',
	'pay_orders_search_status_refund' => '已退款',
	'pay_orders_search_id' => '订单号',
	'pay_orders_search_users' => '付款用户名(多个用户名间请用半角逗号 "," 隔开)',
	'pay_orders_search_buyer' => '付款用户的支付宝用户号或者微信openid',
	'pay_orders_search_admin' => '人工补单管理员',
	'pay_orders_search_submit_date' => '订单提交时间范围(yyyy-mm-dd)',
	'pay_orders_search_confirm_date' => '订单确认时间范围(格式 yyyy-mm-dd)',
	'pay_orders_validate' => '人工补单',
	'pay_orders_id' => '订单号',
	'pay_orders_status' => '订单状态<br />(补单管理员)',
	'pay_orders_status1' => '订单状态',
	'pay_orders_admin' => '补单管理员',
	'pay_orders_type' => '支付类型',
	'pay_orders_uid' => '用户名',
	'pay_orders_username' => '付款用户名',
	'pay_orders_buyer' => '付款人',
	'pay_inviteorders_buyer' => '付款人 / IP',
	'pay_orders_amount' => '收入积分',
	'pay_orders_price' => '支出人民币',
	'pay_orders_submitdate' => '提交时间',
	'pay_orders_confirmdate' => '确认时间',
	'pay_orders_refund' => '退款',
	'pay_orders_op' => '操作',
	'pay_orders_view' => '查看',
	'pay_orders_trade_no' => '支付宝或微信交易号',
	'pay_orders_credit_refund' => '对积分退款',
