...
<br />(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
	...
	'ec_weixin' => '微信支付设置',
	'ec_weixin_tips' => '<li>微信支付（https://pay.weixin.qq.com）是腾讯集团旗下中国领先的第三方支付平台，一直致力于为用户和企业提供安全、便捷、专业的在线支付服务。以“微信支付，不止支付”为核心理念，为个人用户创造了多种便民服务和应用场景，为各类企业以及小微商户提供专业的收款能力，运营能力，资金结算解决方案，以及安全保障。企业、商品、门店、用户已经通过微信连在了一起，让智慧生活，变成了现实。</li><li><b>由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用微信支付积分交易功能(不包含支付宝按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。</b></li><li>您使用微信支付服务是建立在完全自愿的基础上，除 Discuz! 因主观恶意的因素造成的资金损失以外，腾讯云不对因使用此功能造成的任何损失承担责任。</li><li>微信支付客户服务电话为 95017。</li>',
	'ec_weixin_on' => '是否启用微信支付',
	'ec_weixin_version' => 'API版本',
	'ec_weixin_version_comment' => 'APIV3要求PHP版本 >= 7.2',
	'ec_weixin_version_2' => 'API',
	'ec_weixin_version_3' => 'APIV3',
	'ec_weixin_appid' => '(必须)公众号APPID',
	'ec_weixin_appid_comment' => '微信公众号必须有开通微信商户平台',
	'ec_weixin_appsecret' => '(必须)公众号APPSECRET',
	'ec_weixin_mch_id' => '(必须)商户号',
	'ec_weixin_mch_id_comment' => '微信支付分配的商户号',
	'ec_weixin_v1_key' => '(必须)API密钥',
	'ec_weixin_v1_key_comment' => '微信商户平台-->账户设置-->API安全-->密钥设置 - API密钥',
	'ec_weixin_v1_cert' => '(可选)支付证书路径',
	'ec_weixin_v1_cert_comment' => 'cert.p12证书的位置；建议修改文件名称，避免被直接访问；退款时用到，如果不办理退款业务，可以不填。必须在网站目录中，如：source/data/{randomstr}.p12',
	'ec_weixin_v3_private_key' => '(必须)API证书私钥',
	'ec_weixin_v3_private_key_comment' => '商户申请/更换商户API证书(微信商户平台-->账户设置-->API安全-->API证书)时，会生成API证书私钥，并保存在本地证书文件夹的文件apiclient_key.pem 中。',
	'ec_weixin_v3_serial_no' => '(必须)API证书序列号',
	'ec_weixin_v3_serial_no_comment' => '在<a href=\"https://pay.weixin.qq.com/\" target=\"_blank\">微信商户平台</a> - 账户中心 - <a href=\"https://pay.weixin.qq.com/index.php/core/cert/api_cert\" target=\"_blank\">API安全</a> - API证书 - 查看证书 - 证书序列号',
	'ec_weixin_v3_key' => '(必须)APIV3密钥',
...
<li><b>由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用财付通积分交易功能(不包含财付通按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。</b></li><li>您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买帖子内容、购买用户组权限、积分转账或用户组升级等功能。财付通积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款财付通账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。</li><li>除 Discuz! 官方网站或官方论坛另行通知以外，Discuz! 提供的财付通支付服务每笔交易收取 1% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Discuz! 官方网站或官方论坛提供的信息为准。</li><li>您使用财付通服务是建立在完全自愿的基础上，除 Discuz! 因主观恶意的因素造成的资金损失以外，腾讯云不对因使用此功能造成的任何损失承担责任。</li><li>财付通服务热线：0755-83762288-2(全天24小时服务热线)</li>',
	...
	'ec_paymentorders_channel_weixin' => '微信支付',
