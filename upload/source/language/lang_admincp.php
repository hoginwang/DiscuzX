...
',
	...
	'setting_attach_basic_url_comment' => '可为当前 URL 下的相对地址或 http:// 或 https:// 开头的绝对地址，结尾不加 "/"，不能把这个设为远程附件URL地址',
...
<br />(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
	...
	'adv_edit_style_text_link_comment' => '请输入文字广告指向的 URL 链接地址。<strong>注意：站外的地址必须以http:// 或https:// 开头</strong>',
