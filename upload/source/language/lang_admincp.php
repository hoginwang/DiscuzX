...
(
	...
	'req_ver_too_low' => '您当前系统内的 {req} 版本 ({now_ver}) 过低，程序无法按预期正常运行。我们强烈建议您升级到 {sug_ver} 版本，程序正常运行最低要求为 {req_ver} 版本。我们不对您在此状态下继续运行程序出现的任何问题负责。',
	'req_not_found' => '您当前系统内未安装或开启 {req} 模块，程序无法按预期正常运行。我们强烈建议您安装或开启此模块，以满足程序正常运行的最低要求。我们不对您在此状态下继续运行程序出现的任何问题负责。',
