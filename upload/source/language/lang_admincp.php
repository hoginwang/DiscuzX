...
$lang = array
(
	'req_ver_too_low' => '您当前系统内的 {req} 版本 ({now_ver}) 过低，程序无法按预期正常运行。我们强烈建议您升级到 {sug_ver} 版本，程序正常运行最低要求为 {req_ver} 版本。腾讯云计算（北京）有限责任公司不对您在此模式下继续运行程序出现的任何问题负责。',
	'req_not_found' => '您当前系统内未安装或开启 {req} 扩展，程序无法按预期正常运行。我们强烈建议您安装此扩展，这是程序正常运行的最低要求。腾讯云计算（北京）有限责任公司不对您在此模式下继续运行程序出现的任何问题负责。',
