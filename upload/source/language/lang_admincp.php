...
<li><b>由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用财付通积分交易功能(不包含财付通按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。</b></li><li>您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买帖子内容、购买用户组权限、积分转账或用户组升级等功能。财付通积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款财付通账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。</li><li>除 Discuz! 官方网站或官方论坛另行通知以外，Discuz! 提供的财付通支付服务每笔交易收取 1% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Discuz! 官方网站或官方论坛提供的信息为准。</li><li>您使用财付通服务是建立在完全自愿的基础上，除 Discuz! 因主观恶意的因素造成的资金损失以外，腾讯云不对因使用此功能造成的任何损失承担责任。</li><li>财付通服务热线：0755-83762288-2(全天24小时服务热线)</li>',
	...
	'pay_alipay_tips' => '<li>支付宝(<a href="https://open.alipay.com/" target="_blank">https://open.alipay.com</a>) 接口加签方式采用是<b>RSA2</b>(PHP 7.0以上)，安全建议网站采用<b>HTTPS协议</b>，支持PC端，手机浏览器。</li> ',
	...
	'pay_wechat_tips' => '<li>微信支付(<a href="https://pay.weixin.qq.com/" target="_blank">https://pay.weixin.qq.com</a>)，微信支付接口采用是<b>APIV3</b> (PHP 7.1以上或者安装libsodium-php)，安全建议网站采用<b>HTTPS协议</b>，支持PC端，手机浏览器，微信浏览器。</li>',
	...
	'pay_wechat_privateKey_comment' =>'必须配置! https://kf.qq.com/faq/161222NneAJf161222U7fARv.html 请保存在本地证书文件 apiclient_key.pem 删除首尾2行，再将其他内容（多行），把转行删除得到所需的一行（复制进来即可）',
	'pay_wechat_cert' =>'平台公钥存储地址',
	'pay_wechat_cert_comment' =>'必须配置!  默认：data/cert ，可以自定义（请将文件夹创建好）。所有参数都设置保存后，请点击<a href="'.ADMINSCRIPT.'?action=pay&operation=wechat&cert=update">更新平台公钥</a>，将在你设置存储地址生成平台公钥文件（后缀为.pem），必须拥有此文件才能进行微信支付！',
