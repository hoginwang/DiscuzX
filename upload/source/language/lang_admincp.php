...
(
	...
	'report_optuser' => '处理人',
	'report_opttime' => '处理时间',
	'report_receive_tips' => '<li>下面列出了在管理中心有举报管理权限的管理员及全部超级版主。</li><li>有新的举报时将给所有选中用户发送通知。</li><li>当有新的帖子被举报时同时会给相应版主发送通知。</li>',
	...
	'home_security_founder' => '<li>您可以制定多种团队职务分配给您网站管理团队的各个成员，让他们管理网站的不同事务<li>“<strong>副站长</strong>”拥有除“创始人(站长)”专有权限以外的所有管理中心权限，仅次于“创始人(站长)”</li>',
	'home_security_nofounder' => '<li>您尚未设置 <u>站点创始人</u>，所有在管理员用户组的用户均可以登录管理中心。请修改 config/config_global.php 添加创始人，以有效控制管理团队成员的权限范围',
	'home_security_checkip' => '<li>您关闭了 <u>管理员IP验证</u>。建议只有在管理员无法登录管理中心的时候才关闭此项检查。修改 config/config_global.php 当中的相应设置可以开启此功能',
...
',
	...
	'setting_sec_seccode_rule_login_pwsimple_comment' => '当用户登录时使用的密码的长度与复杂度不符合管理中心设置时',
...
<br />(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
	...
	'members_edit_freeze_admincp' => '需管理中心审核后解冻',
	'members_edit_freeze_email' => '需验证邮箱或管理中心审核后解冻',
	...
	'founder_perm_allowpost' => '<span title="设置成员能修改设置的内容，否则只能浏览管理中心信息，不能设置。">开启授权</span>',
	...
	'usergroups_edit_basic_forcesecques_comment' => '选择“是”则此用户组的用户在登录管理中心前必须设置安全提问后才可登录管理中心, config中为全局开关',
	...
	'card_config_open_comment' => '设置是否允许前台充值，关闭前台充值功能，不影响管理中心卡密的生成<br />充值卡密验证码开关：<a href="'.ADMINSCRIPT.'?action=setting&operation=seccheck">全局->安全->验证设置</a>',
	'card_number' =>'卡密',
	'card_number_unit' => '位',
	...
	'card_manage_maketype_0' => '管理中心批量生成',
...
<li><b>由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用财付通积分交易功能(不包含财付通按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。</b></li><li>您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买帖子内容、购买用户组权限、积分转账或用户组升级等功能。财付通积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款财付通账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。</li><li>除 Discuz! 官方网站或官方论坛另行通知以外，Discuz! 提供的财付通支付服务每笔交易收取 1% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Discuz! 官方网站或官方论坛提供的信息为准。</li><li>您使用财付通服务是建立在完全自愿的基础上，除 Discuz! 因主观恶意的因素造成的资金损失以外，腾讯云不对因使用此功能造成的任何损失承担责任。</li><li>财付通服务热线：0755-83762288-2(全天24小时服务热线)</li>',
	...
	'db_runquery' => '数据库升级',
	'db_runquery_tips' => '<li>您可以通过修改 /source/admincp/admincp_quickquery.php 来添加常用 SQL 操作进行功能扩充。</li><li>出于安全考虑，Discuz! 管理中心默认情况下禁止 SQL 语句直接执行，只能使用常用 SQL 当中的内容，<br />如果您想自己随意书写 SQL 升级语句，需要将 config/config_global.php 当中的 $_config[admincp][runquery] 设置修改为 1。</li>',
