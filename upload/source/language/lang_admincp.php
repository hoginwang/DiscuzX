...
<br />(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
	...
	'members_export_tips' => '<li>用户组名称以黑体字显示的，为系统用户组；以斜体字显示的，为自定义用户组；否则为会员用户组。</li><li>导出用户信息最多支持 10000 条数据。导出的 .csv 文件可用 EXCEL 打开。</li>',
	...
	'succeed_num' => '成功数',
	'fail_num' => '失败数',
	'card_manage_tips' => '<li>导出充值卡密最多支持 10000 条数据，导出的 .csv 文件可用 EXCEL 等工具打开。</li>',
