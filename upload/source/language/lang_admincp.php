...
<br />(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
	...
	'forums_edit_posts_disableoldthreadview' => '已关闭主题自动关闭浏览',
	'forums_edit_posts_disableoldthreadview_comment' => '设置已关闭主题在最后一个回复后和对非管理员用户关闭浏览之间的秒数， 0 为关闭此功能',
	'forums_edit_posts_dotvwithoutdisplayorder' => '已关闭主题自动关闭浏览时忽略置顶帖',
	'forums_edit_posts_dotvwithoutdigest' => '已关闭主题自动关闭浏览时忽略精华帖',
	'forums_edit_posts_dotvwithoutuids' => '已关闭主题自动关闭浏览时不关闭的 UID 列表',
	'forums_edit_posts_dotvwithoutuids_comment' => '设置已关闭主题自动关闭浏览时忽略 UID 列表，多个 UID 之间用半角逗号 "," 隔开，留空为所有账号均受限制',
