...
',
	...
	'setting_sec_accountguard_loginoutofdate_comment' => '当用户距离上次登录超过一定天数时（推荐配置为 60 天），帐号会进入未审核组，用户可以通过验证邮箱或者申诉解冻帐号，QQ登录的用户不受此功能影响，0 为关闭此功能 <a href="'.ADMINSCRIPT.'?action=moderate&operation=members">审核用户</a>',
