...
(
    ...
    'setting_basic_icp' => '网站ICP备案信息代码',
    'setting_basic_icp_comment' => '页面底部可以显示 <a href="http://www.miitbeian.gov.cn" target="_blank">ICP</a> 备案信息，如果网站已备案，在此输入您的授权码，它将显示在页面底部，如果没有请留空',
    'setting_basic_beian' => '网站公安备案信息代码',
    'setting_basic_beian_comment' => '页面底部可以显示 <a href="http://www.beian.gov.cn" target="_blank">全国公安机关互联网安全管理中心</a> 备案信息，如果网站已备案，在此输入您的授权码，它将显示在页面底部，如果没有请留空',
...
',
    ...
    'setting_functions_mod_warningrange' => '警告时间范围（天）',
    'setting_functions_mod_warningrange_comment' => '检测多久天范围内的有效警告次数，超过不作为依据',
    'setting_functions_mod_warninglimit' => '用户被警告次数',
	'setting_functions_mod_warninglimit_comment' => '用户被警告次数超过该值后自动禁言',
	'setting_functions_mod_warningexpiration' => '警告有效期(天)',
	'setting_functions_mod_warningexpiration_comment' => '警告有效期（天）后，自动解除用户禁言',
