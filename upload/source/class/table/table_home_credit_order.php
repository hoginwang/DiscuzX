 ...
 *
 *      $Id: table_home_credit_order.php 29009 2012-03-22 07:37:36Z aphly $
 */
...
class table_home_credit_order extends discuz_table
{
	public function __construct() {

		$this->_table = 'home_credit_order';
		$this->_pk    = 'orderid';
	...
	*/
	...
	public function fetchForUpdate($orderid){
		if(empty($orderid)) {
			return array();
		}
		return DB::fetch_first('SELECT * FROM %t WHERE '.DB::field('orderid', $orderid).' for update', array($this->_table));
	}
