		...
		if(!submitcheck('loginsubmit', 1, $seccodestatus)) {
			...
			if($result['status'] > 0) {
				...
				if($_G['member']['adminid'] != 1) {
					if($this->setting['accountguard']['loginoutofdate'] && $_G['member']['lastvisit'] && TIMESTAMP - $_G['member']['lastvisit'] > $this->setting['accountguard']['loginoutofdate'] * 86400 && $_G['member']['freeze'] != -1) {
