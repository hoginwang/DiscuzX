...
<style type="text/css">
	body {font-family: Verdana; font-size: 12px; margin: 0; color: #000; background: #fff;}
	img {border: 0;}
	li {margin-top: 8px;}
	.page {padding: 4px; border-top: 1px #eee solid;}
	.author {background-color:#eef; padding: 6px; border-top: 1px #dde solid;}
	#nav, #content, #end {padding: 8px; border: 1px solid #eee; clear: both; width: 95%; margin: auto; margin-top: 10px;}
	#header, #footer {margin-top: 20px;}
	#loginform, .center {text-align: center;}
</style>
</head>
