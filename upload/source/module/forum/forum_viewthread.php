...
function viewthread_baseinfo($post, $extra) {
	...
	if(substr($key, 0, 10) == 'extcredits') {
		...
		if($field != 'qq') {
			...
			$v = '<a href="tencent://Message/?uin='.$post['qq'].'&site='.$_G['setting']['bbname'].'&menu=yes&from=discuz" target="_blank" title="'.lang('spacecp', 'qq_dialog').'"><img src="'.STATICURL.'/image/common/qq_big.gif" alt="QQ" style="margin:0px;"/></a>';
		}
		if($v) {
