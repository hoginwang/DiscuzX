...
if($_G['forum_cachepid']) {
	...
	if($_G['forum_cachepid'] && $_G['setting']['commentnumber']) {
		...
		array_merge($comments, $tmppostcomment[0]);
		array_merge($postcache, $tmppostcomment[1]);
		array_merge($commentcount, $tmppostcomment[2]);
		array_merge($totalcomment, $tmppostcomment[3]);
