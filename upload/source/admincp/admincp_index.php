...
function show_user_bar() {
	...
	showsubmenu('home_welcome', array(), '</div><div class="dbox hometop"><img src="'.avatar(getglobal('uid'), 'middle', true).'" onerror="this.onerror=null;this.src=\''.$_G['setting']['ucenterurl'].'/images/noavatar.svg\'" class="avt">
	<div class="hinfo">
