...
$env_ok = true;
$now_ver = array("PHP" => constant("PHP_VERSION"), "MySQL" => helper_dbtool::dbversion(), "filter_var" => function_exists("filter_var"), "GD" => (function_exists('gd_info') ? preg_replace('/[^0-9.]+/','',gd_info()['GD Version']) : false));
$req_ver = array("PHP" => '5.3', "MySQL" => '5.0', "filter_var" => true, "GD" => '1.0');
$sug_ver = array("PHP" => '7.1', "MySQL" => '5.7', "filter_var" => true, "GD" => '2.0');
