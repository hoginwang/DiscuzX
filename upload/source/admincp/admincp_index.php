...
function show_forever_thanks() {
	...
	showboxrow('', array('class="dcol d-1 lineheight"', 'class="dcol lineheight team"'), array('', '<a href="https://gitee.com/Discuz/DiscuzX/contributors?ref=v3.5" class="lightlink2" target="_blank">'.cplang('contributors_see').'</a>'));
