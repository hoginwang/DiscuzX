	...
	if($step == 1) {
		...
		if($homecheck) {
			...
			echo "<div><em class=\"".($modifiedfiles ? 'edited' : 'correct')."\">{$lang['filecheck_modify']}<span class=\"bignum\">$modifiedfiles</span></em>".
				...
				"<em class=\"".($unknownfiles ? 'unknown' : 'correct')."\">{$lang['filecheck_unknown']}<span class=\"bignum\">$unknownfiles</span></em>".
				"<em class=\"".($doubt ? 'unknown' : 'correct')."\">{$lang['filecheck_doubt']}<span class=\"bignum\">$doubt</span></em></div><p>".
