...
EOT;
		...
		echo '<img src="'.avatar(getglobal('uid'), 'middle', true).'" onerror="this.onerror=null;this.src=\''.$_G['setting']['ucenterurl'].'/images/noavatar.svg\'" class="avt"><h1>'.getglobal('member/username').'</h1>';
	}
