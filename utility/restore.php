...
function lang($lang_key, $force = true, $replace = array()) {
	...
	$lang = array(
		...
		'database_import_multivol_succeed' => '分卷数据成功导入站点数据库<br />请在管理中心更新缓存<br /><span class="red">出于安全考虑，我们强烈建议您恢复数据库备份文件后删除文件或设置文件不可通过 URL 访问。</span><br /><span class="red">请尽快删除restore.php文件，以免对数据造成影响</span>',
		...
		'database_import_succeed' => '数据已成功导入站点数据库<br />请在管理中心更新缓存<br /><span class="red">出于安全考虑，我们强烈建议您恢复数据库备份文件后删除文件或设置文件不可通过 URL 访问。</span><br /><span class="red">请尽快删除restore.php文件，以免对数据造成影响</span>',
