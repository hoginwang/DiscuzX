...
CREATE TABLE pre_common_member_verify (
  ...
  verify8 tinyint(1) NOT NULL DEFAULT '0',
  verify9 tinyint(1) NOT NULL DEFAULT '0',
  verify10 tinyint(1) NOT NULL DEFAULT '0',
  verify11 tinyint(1) NOT NULL DEFAULT '0',
  verify12 tinyint(1) NOT NULL DEFAULT '0',
  verify13 tinyint(1) NOT NULL DEFAULT '0',
  verify14 tinyint(1) NOT NULL DEFAULT '0',
  verify15 tinyint(1) NOT NULL DEFAULT '0',
  verify16 tinyint(1) NOT NULL DEFAULT '0',
  verify17 tinyint(1) NOT NULL DEFAULT '0',
  verify18 tinyint(1) NOT NULL DEFAULT '0',
  verify19 tinyint(1) NOT NULL DEFAULT '0',
  verify20 tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (uid),
  KEY verify1 (verify1),
  KEY verify2 (verify2),
  KEY verify3 (verify3),
  ...
  KEY verify8 (verify8),
  KEY verify9 (verify9),
  KEY verify10 (verify10),
  KEY verify11 (verify11),
  KEY verify12 (verify12),
  KEY verify13 (verify13),
  KEY verify14 (verify14),
  KEY verify15 (verify15),
  KEY verify16 (verify16),
  KEY verify17 (verify17),
  KEY verify18 (verify18),
  KEY verify19 (verify19),
  KEY verify20 (verify20)
) TYPE=MyISAM;
